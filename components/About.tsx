      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative aspect-square overflow-hidden rounded-2xl border border-white/10 shadow-2xl bg-[#0f1115]">
            ...
            {!isLoaded && (
              <div className="absolute inset-0 flex items-center justify-center">
                <i className="fa-solid fa-gear animate-spin text-blue-500 text-2xl"></i>
              </div>
            )}
        ...
        <div className="space-y-6">
          ...
          <div className="pt-6">
            ...
            >
              Get In Touch
              <i className="fa-solid fa-arrow-right text-xs text-blue-500 group-hover:translate-x-1 transition-transform"></i>
            </button>
          </div>
        </div>
      </div>
